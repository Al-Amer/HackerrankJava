/*
Balanced System Files Partition The directory structure of a system disk partition is represented as a tree.
Its n directories are numbered from 0 to n-1, where the directory has the number 0. The structure of the tree
is defined by a parent array, where parent - means that the directory/is direct subdirectory of j
 */

package ProblemSolving.certificatesTest.BalancedSystemFilesPartition;
